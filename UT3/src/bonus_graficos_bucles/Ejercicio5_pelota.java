...
// Pelota: Crea un programa que dibuje un círculo en la pantalla. Haz que el círculo se mueva por la pantalla, rebotando en sus bordes.
import objetos.graphics.Color;
import objetos.graphics.Ellipse;
import objetos.graphics.Rectangle;

public class Ejercicio5_pelota {
