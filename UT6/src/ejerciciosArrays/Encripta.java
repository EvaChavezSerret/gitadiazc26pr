 ...
 * 
 *  Dada una cadena de caracteres, en la cadena encriptada cada caracter será igual a
 *  él mismo más el caracter que se encuentra a continuación. Si nos encontramos en
 *  el último valor le sumaremos 4.
 *  
 *  Una vez realizada la operación anterior sumaremos 3 a cada caracter obteniendo
