 ...
 * si es necesario porque se avanza un día. Crea el método aCadena (toString()) que muestre la fecha y la 
 * hora de forma conjunta. Escribe un programa que pruebe la nueva clase, especialmente el incremento de de 
